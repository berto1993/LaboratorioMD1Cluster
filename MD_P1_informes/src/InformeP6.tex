...
Los problemas en los que los datos de entrenamiento son vectores x sin una clase
definida son conocidos como problemas de clasificación no
supervisada.[\ref{Bishop}, Página 3, 2º Párrafo]
...
en las distintas predicciones.[\ref{Elements}, Página 486,
3ºlinea][\ref{Handbook}, Sección 14.1, 1º Párrafo]
...
\end{figure}
ajfjdkljakljflkasjfkladjfaljfkajfkajdfklajfajsdfkjadslfjadslfjasdkfjasdkljflasdkjfajdfkladsjflakjfklasdjfñljasfjalskfjaskljfkajfkñlasdj
