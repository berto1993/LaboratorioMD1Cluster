...
x sin una clase definida.\cite{Bishop}%, Página 3, 2º Párrafo
...
en las distintas predicciones.\cite{Elements}% , Página 486,3ºlinea 
\cite{Handbook}%, Sección 14.1, 1º Párrafo
